...
export default function StudentCertificateRequests(){
	return(
		...
		<div className="sidebar">
			...
			<div className="sidebar-menu">
				<ul>
					...
					<li>
						<Link to="/student-certificate-requests" className="active"><span className="las la-certificate"></span><span>Certificate Request</span>
						<span>
						</span></Link>
					</li>
					<li>
