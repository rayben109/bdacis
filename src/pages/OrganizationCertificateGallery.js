...
export default function OrganizationCertificateGallery(){
	return(
		...
		<div className="sidebar">
			...
			<div className="sidebar-menu">
				<ul>
					...
					<li>
						<Link to="/organization-certificate-gallery"  className="active"><span><AiOutlinePicture/></span><span>Certificate Gallery</span>
						<span>
						</span></Link>
					</li>
					<li>
